...
/* Device setup */
#define CTRL_DEFAULT                    0b1111000111100011

#define MUX_OUT_MASK                    0b0000000011100000
#define MPIN_F_BUS_OUT_BITS             0b0000000010000000
#define MPIN_A_OUT_BITS                 0b0000000000000000
#define MPIN_B_OUT_BITS                 0b0000000000100000
#define MPIN_ADDSUB_OUT_BITS            0b0000000001000000
#define MPIN_RAM_OUT_BITS               0b0000000001100000
#define MPIN_PC_OUT_BITS                0b0000000010100000

#define MUX_LOAD_MASK                   0b1110000000000000
#define MPIN_A_LOAD_BITS                0b0000000000000000
#define MPIN_B_LOAD_BITS                0b0010000000000000
#define MPIN_MAR_LOAD_BITS              0b0100000000000000
#define MPIN_RAM_WRITE_BITS             0b0110000000000000
#define MPIN_IR_LOAD_BITS               0b1000000000000000
#define MPIN_PC_LOAD_BITS               0b1010000000000000
#define MPIN_OUT_LOAD_BITS              0b1100000000000000

#define LPIN_F_LOAD_BIT                 0b0000000000000010
#define HPIN_F_USE_CARRY_BIT            0b0000000000001000
#define HPIN_F_BUS_IN_BIT               0b0000001000000000
#define LPIN_CLOCK_HALT_BIT             0b0000000100000000
#define LPIN_STEPS_RESET_BIT            0b0000000000000001
#define LPIN_IRFETCH_LOAD_BIT           0b0001000000000000
#define HPIN_ADDSUB_SUB_BIT             0b0000000000010000
#define HPIN_PC_COUNT_BIT               0b0000000000000100
