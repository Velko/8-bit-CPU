...
class MainWindow(MainUI):
    ...
    def on_debugger_stop(self, reason: StopReason, addr: int) -> None:
        ...
        self.reg_a_val.set_text(regs['A'])
        self.reg_b_val.set_text(regs['B'])
        self.reg_c_val.set_text(regs['C'])
        self.reg_d_val.set_text(regs['D'])

        self.flags_val.set_text(regs['Flags'])
        self.pc_val.set_text(regs['PC'])
        self.lr_val.set_text(regs['LR'])
        self.sp_val.set_text(regs['SP'])
